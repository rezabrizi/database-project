...
export default function LoginPage() {
    ...
    const handleLogin = async () => {
        ...
        const resp = await fetch("/user/login", {
            ...
            body: JSON.stringify({user: user, gameId: parseInt(gameId)}),
        }).then((res) => res.json())
            .then((res) => {
                console.log(res)
                return res
        ...
        console.log(resp)
        // try { const response = await axios.post('/user/login', { username });
    ...
    const handleEnterGame = async () => {
        ...
        try {
            ...
            console.log(await axios.post('/game/enter', {user, game_Id}));
            // gameEntryResponse
